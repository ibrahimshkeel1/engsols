...
export function NewsDisciplineFilter({ active }: { active: string }) {
  ...
  return (
    <div className="sticky top-16 z-20 -mx-4 border-b border-border-custom bg-bg-main px-4 py-3 sm:-mx-6 sm:px-6 lg:top-20">
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                selected
                  ? "border-zone-news bg-zone-news text-white shadow-sm"
