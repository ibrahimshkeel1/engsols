    ...
    >
      ...
      >
        ...
        <Image
          ...
          width={56}
          height={56}
          className="shrink-0 rounded-xl ring-2 ring-white/20 transition-transform duration-300 group-hover:scale-105"
          unoptimized
        />
        ...
        <ArrowRight className="h-4 w-4 shrink-0 self-center text-white/40 transition-all duration-300 group-hover:translate-x-1 group-hover:text-primary group-hover:opacity-100 opacity-0" />
      </Link>
    </motion.div>
  );
}
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          <div>
            ...
            <motion.h1
              ...
              animate="visible"
              variants={fadeUp}
              className="font-display mt-4 text-4xl leading-[1.08] tracking-tight sm:text-5xl lg:text-[3.5rem]"
            >
              Learn from engineers who&apos;ve{" "}
              <span className="shimmer-text">done it</span>
            </motion.h1>
            <motion.p
              custom={2}
              initial="hidden"
              animate="visible"
              variants={fadeUp}
              className="text-muted-hero mt-5 max-w-lg text-lg leading-relaxed"
            >
            ...
            >
              {heroDisciplines.map((d) => (
                <Link
                  ...
                  className="rounded-full border border-white/15 bg-white/5 px-3.5 py-1.5 text-xs font-medium text-white/80 backdrop-blur-sm transition-all duration-300 hover:border-primary/60 hover:bg-primary/15 hover:text-white hover:shadow-lg hover:shadow-primary/10"
                >
                  {d}
                </Link>
              ))}
          ...
          <div className="space-y-3">
            ...
            <motion.p
              ...
              animate="visible"
              variants={fadeUp}
              className="pt-2 text-center text-sm text-white/40"
            >
