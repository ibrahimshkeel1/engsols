...
export const FLUID_DROP_PEBBLE =
  "bubble-pebble flex items-center justify-center w-auto shrink-0 px-5 py-3.5 text-base font-medium lowercase tracking-wide rounded-[40px_70px_50px_60px_/_50px_60px_40px_70px] shadow-sm sm:px-8 sm:py-5 sm:text-lg";
