...
export function PageHero({
  ...
  if (variant === "live") {
    return (
      <section className={cn("border-b border-border bg-muted/50", className)}>
        <div className="mx-auto flex max-w-7xl flex-col justify-between gap-6 px-4 py-14 sm:px-6 sm:flex-row sm:items-end">
          <div className="animate-fade-up">
            ...
            <div className="mt-4 flex items-center gap-2">
              ...
              <span className="text-xs font-semibold uppercase tracking-widest text-red-600 dark:text-red-400">Live Sessions</span>
            </div>
